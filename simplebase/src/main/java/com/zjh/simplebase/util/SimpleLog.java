...
public class SimpleLog {
    ...
    protected static boolean IS_SHOW_LOG = false;
    ...
    public static void v(ILazy lazy) {
        v(lazy.getMsg());
    }

    public static void v(String tag, ILazy lazy) {
        v(tag, lazy.getMsg());
    }
    ...
    public static void d(ILazy lazy) {
        if (IS_SHOW_LOG) {
            d(lazy.getMsg());
        }
    }
    ...
    public static void d(String tag, ILazy lazy) {
        if (IS_SHOW_LOG) {
            d(tag, lazy.getMsg());
        }
    }
    ...
    public static void i(ILazy lazy) {
        if (IS_SHOW_LOG) {
            i(lazy.getMsg());
        }
    }
    ...
    public static void i(String tag, ILazy lazy) {
        if (IS_SHOW_LOG) {
            i(tag, lazy.getMsg());
        }
    }
    ...
    public static void w(ILazy lazy) {
        if (IS_SHOW_LOG) {
            w(lazy.getMsg());
        }
    }

    public static void w(String tag, ILazy lazy) {
        if (IS_SHOW_LOG) {
            w(tag, lazy.getMsg());
        }
    }
    ...
    public static void e(ILazy lazy) {
        if (IS_SHOW_LOG) {
            w(lazy.getMsg());
        }
    }

    public static void e(String tag, ILazy lazy) {
        w(tag, lazy.getMsg());
    }
    ...
    public static void a(ILazy lazy) {
        if (IS_SHOW_LOG) {
            a(lazy.getMsg());
        }
    }

    public static void a(String tag, ILazy lazy) {
        a(tag, lazy.getMsg());
    }
